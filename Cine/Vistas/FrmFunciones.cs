    ...
    public partial class FrmFunciones : Form
    {
        ...
        private async void btnBuscar_Click(object sender, EventArgs e)
        {
            if (cboPeliculas.SelectedIndex > -1)
            {
                ...
                if (lFunciones != null)
                {
                    ...
                    {
                        dgvFunciones.Rows.Add(new object[] { f.oPelicula.Titulo, f.oSala.IdSala, f.oSala.TipoSala, f.DiaMostrar, f.HoraMostrar, "Comprar" });
                    }
        ...
        private async void dgvFunciones_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvFunciones.CurrentCell.ColumnIndex == 5)
            {
                ...
                if (resultado)
                {
                    FrmButacas frmButacas = new FrmButacas(lFunciones[dgvFunciones.CurrentRow.Index], int.Parse(nudCantidad.Value.ToString()));
